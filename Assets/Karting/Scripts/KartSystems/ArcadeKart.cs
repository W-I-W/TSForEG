...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        void MoveVehicle(bool accelerate, bool brake, float turnInput)
        {
            ...
            bool isTurnInput = Mathf.Abs(turnInput) > 0.9f; //Mathf.Approximately(Mathf.Abs(turnInput), 1);
            bool isBraking = (localVelDirectionIsFwd && isTurnInput) || (!localVelDirectionIsFwd && accelerate);
